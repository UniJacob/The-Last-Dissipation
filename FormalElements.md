...
---
הרכיב הרשמי שידיגש את ייחודיות המשחק באופן הכי משמעותי הוא היעדים והתהליכים: לרוב המשחקים הדומים לשלי בשוק אין מטרה סופית, אלא השחקן פשוט משחק בשבלים כרצונו בשביל המוזיקה ובשביל תחושת הסיפוק מלעבור אותם עם ניקוד טוב. במשחק שלי יש שימוש לניקוד מעבר לתחושת סיפוק, מה שמוסיף מטרה לשחקנים וגורם לחוויה יותר מספקת. כמו כן גם הסיפור והמוזיקה ייחודיים ומקוריים.
