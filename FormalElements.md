...
השלבים וה-interface שלהם במשחק שלי דומים לאלה שב-Cytus. עם זאת, הגרפיקה די שונה וברור יותר מתי צריך ללחוץ על תו בשביל לקבל את הניקוד המרבי ממנו ("Perfect"). במשחק שלי אולי גם יהיה Night Mode (פחות צבעים בהירים) שיהיה "קל" יותר על העיניים.
...
בדומה למשחק שלי, Deemo Reborn הוא גם משחק-קצב שבו יש overworld בו על השחקנים לשוטט בשביל להכנס לשלבים. עם זאת, הם שונים לחלוטין וכל אחד מתאים לסיפור שלו. כמו כן במשחק שלי האינטרקציה של השחקן עם המסך יותר פשוטה ואינטואיטיבית.

---
הרכיב הרשמי שידיגש את ייחודיות המשחק באופן הכי משמעותי הוא היעדים והתהליכים: לרוב המשחקים הדומים לשלי בשוק אין מטרה סופית, אלא השחקן פשוט מנגן את השלבים כרצונו בשביל המוזיקה ובשביל תחושת הסיפוק מלעבור אותם עם ניקוד טוב. במשחק שלי יש שימוש לניקוד מעבר לתחושת סיפוק, מה שמוסיף מטרה לשחקנים וגורם לחוויה יותר מספקת. כמו כן גם הסיפור והמוזיקה ייחודיים ומקוריים.
