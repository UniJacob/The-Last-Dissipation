...
* Cytus [(link)]([url](https://play.google.com/store/apps/details?id=com.rayark.Cytus.full&hl=en&pli=1))
![maxresdefault](https://github.com/user-attachments/assets/766138d9-e240-4b8a-ab70-2a8549fc487b)
השלבים וה-interface שלהם במשחק שלי דומים לאלה שב-Cytus. עם זאת, הגרפיקה די שונה וברור יותר מתי צריך ללחוץ על תו בשביל לקבל את הניקוד המרבי ממנו ("Perfect"). אולי גם יהיה Night Mode לגרפיקת המשחק (פחות צבעים בהירים).

* Deemo [(link)]([url](https://store.steampowered.com/app/1282210/DEEMO_Reborn/))
...
בדומה למשחק שלי, Deemo הוא גם משחק-קצב שבו יש overworld בו על השחקנים לשוטט בשביל להכנס לשלבים. עם זאת, ה-interface 
